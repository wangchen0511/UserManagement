...
import com.user.management.exceptions.AlreadyVerifiedException;
import com.user.management.exceptions.AuthenticationException;
import com.user.management.exceptions.TokenHasExpiredException;
import com.user.management.exceptions.TokenNotFoundException;
...
import com.user.management.repositories.VerificationTokenRepository;
...
public class VerificationTokenServiceImpl extends BaseService implements VerificationTokenService {
    ...
    private VerificationToken loadToken(String base64EncodedToken) {
        Assert.notNull(base64EncodedToken);
        String rawToken = new String(Base64.getDecoder().decode(base64EncodedToken));
